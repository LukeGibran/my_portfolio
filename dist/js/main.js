...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _typewrite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./typewrite */ \"./js/typewrite.js\");\nvar menuBtn = document.querySelector(\".menu-btn\");\nvar menu = document.querySelector(\".menu\");\nvar menuNav = document.querySelector(\".menu-nav\");\nvar menuBranding = document.querySelector(\".menu-branding\");\nvar navItems = document.querySelectorAll(\".nav-item\");\nvar navBg = document.querySelector(\".nav-bg\");\n\nvar showMenu = false;\nmenuBtn.addEventListener(\"click\", toggleMenu);\n\nfunction toggleMenu() {\n  if (!showMenu) {\n    menuBtn.classList.remove(\"hv\");\n    menuBtn.classList.add(\"close\");\n    menu.classList.add(\"show\");\n    menuNav.classList.add(\"show\");\n    menuBranding.classList.add(\"show\");\n    navBg.classList.add(\"show\");\n    navItems.forEach(function (navItem) {\n      return navItem.classList.add(\"show\");\n    });\n    showMenu = true;\n  } else {\n    menuBtn.classList.add(\"hv\");\n    menuBtn.classList.remove(\"close\");\n    menu.classList.remove(\"show\");\n    menuNav.classList.remove(\"show\");\n    menuBranding.classList.remove(\"show\");\n    navBg.classList.remove(\"show\");\n    navItems.forEach(function (navItem) {\n      return navItem.classList.remove(\"show\");\n    });\n    showMenu = false;\n  }\n} // Init On DOM Load\n\n\ndocument.addEventListener(\"DOMContentLoaded\", setTimeout(init, 900)); // Init app\n\nfunction init() {\n  var txtElement = document.querySelector(\".sm-heading\");\n  var words = [\"Web Developer\", \"Web Designer\", \"Programmer\"];\n  var wait = \"3000\"; // Init TypeWriter\n\n  new _typewrite__WEBPACK_IMPORTED_MODULE_0__[\"default\"](txtElement, words, wait);\n}\n\n//# sourceURL=webpack:///./js/menu.js?");
...
/***/ 0:
/*!*****************************************!*\
  !*** multi babel-polyfill ./js/menu.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./js/menu.js */\"./js/menu.js\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./js/menu.js?");
